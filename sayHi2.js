...
var str = ρσ_str, repr = ρσ_repr;;
    ...
    (function(){
        ...
        try {
            ...
            ρσ_last_exception = ρσ_Exception;
            if (ρσ_Exception instanceof ReferenceError) {
        ...
        function say(s) {
            if ((context === "browser" || typeof context === "object" && ρσ_equals(context, "browser"))) {
                document.body.innerHTML += s + "</br>";
            } else {
                print(s);
            }
        };
        if (!say.__argnames__) Object.defineProperties(say, {
        ...
        ρσ_modules.context.language = language;
        ρσ_modules.context.context = context;
        ρσ_modules.context.say = say;
    })();
    ...
    (function(){
        ...
        var i;
        var say = ρσ_modules.context.say;

        for (var ρσ_Index0 = 0; ρσ_Index0 < 10; ρσ_Index0++) {
            i = ρσ_Index0;
            say("" + ρσ_str.format("{}", i) + " Hi!");
        }
    })();
})();